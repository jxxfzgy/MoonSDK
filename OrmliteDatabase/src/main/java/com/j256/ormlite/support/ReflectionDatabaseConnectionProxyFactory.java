 ...
 * have a constructor that takes a {@link com.j256.ormlite.support.DatabaseConnection} object.
 * 
 * @author graywatson
 */
public class ReflectionDatabaseConnectionProxyFactory implements DatabaseConnectionProxyFactory {
	...
	/**
	 * Takes a proxy-class that will be used to instantiate an instance in {@link #createProxy(com.j256.ormlite.support.DatabaseConnection)}.
	 * 
	 * @throws IllegalArgumentException
	 *             if the class does not have a constructor that takes a {@link com.j256.ormlite.support.DatabaseConnection} object.
	 */
