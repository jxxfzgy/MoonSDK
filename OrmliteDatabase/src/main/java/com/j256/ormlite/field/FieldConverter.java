 ...
 * {@link com.j256.ormlite.db.BaseDatabaseType#getFieldConverter(com.j256.ormlite.field.DataPersister)} method to find the converter for a particular database
...
public interface FieldConverter {
	...
	/**
	 * This is usually just a call that takes the result from {@link #resultToSqlArg(com.j256.ormlite.field.FieldType, DatabaseResults, int)}
	 * and passes it through {@link #sqlArgToJava(com.j256.ormlite.field.FieldType, Object, int)}.
	 */
	 ...
	 *            Associated FieldType which may be null.
	 * @param sqlArg
	 *            SQL argument converted with {@link #resultToSqlArg(com.j256.ormlite.field.FieldType, DatabaseResults, int)} which will not be
	 *            null.
	 */
