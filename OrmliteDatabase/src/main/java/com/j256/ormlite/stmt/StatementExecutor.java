...
public class StatementExecutor<T, ID> implements GenericRowMapper<String[]> {
	...
	/**
	 * Return the first object that matches the {@link com.j256.ormlite.stmt.PreparedStmt} or null if none.
	 */
	...
	/**
	 * Return a list of all of the data in the table that matches the {@link com.j256.ormlite.stmt.PreparedStmt}. Should be used carefully if
	...
	/**
	 * Create and return an {@link com.j256.ormlite.stmt.SelectIterator} for the class using a prepared statement.
	 */
	public SelectIterator<T, ID> buildIterator(BaseDaoImpl<T, ID> classDao, ConnectionSource connectionSource,
