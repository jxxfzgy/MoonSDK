...
public abstract class StatementBuilder<T, ID> {
	...
	/**
	 * Returns a {@link com.j256.ormlite.stmt.Where} object that should be used to add SQL where clauses to the statement. This will also
	...
	/**
	 * Set the {@link com.j256.ormlite.stmt.Where} object on the query. This allows someone to use the same Where object on multiple queries.
	 */
