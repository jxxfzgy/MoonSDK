...
public class SelectArg extends BaseArgumentHolder implements ArgumentHolder {
	...
	/**
	 * This constructor is only necessary if you are using the {@link com.j256.ormlite.stmt.Where#raw(String, ArgumentHolder...)} and similar
	 * methods.
	 * 
	 * @param columnName
	 ...
	 *            {@link com.j256.ormlite.stmt.Where#raw(String, ArgumentHolder...)} and similar methods.
	 * @param value
	 *            Value for the select-arg if know at time of construction. Otherwise call {@link #setValue(Object)}
	 *            later.
	 */
