...
public interface ForeignCollection<T> extends Collection<T>, CloseableIterable<T> {
	...
	/**
	 * This is a call through to {@link com.j256.ormlite.dao.Dao#update(Object)} using the internal collection DAO. Objects inside of the
	...
	/**
	 * This is a call through to {@link com.j256.ormlite.dao.Dao#refresh(Object)} using the internal collection DAO. Objects inside of the
	 ...
	 * {@link com.j256.ormlite.dao.Dao#create(Object)}. If the object has already been created in the database then you just need to set the
	 * foreign field on the object and call {@link com.j256.ormlite.dao.Dao#update(Object)}. If you add it here the DAO will try to create it
