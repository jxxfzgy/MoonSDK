...
/**
 * Results returned by a call to {@link com.j256.ormlite.dao.Dao#queryRaw(String, String...)} which returns results as a String[],
 * {@link com.j256.ormlite.dao.Dao#queryRaw(String, com.j256.ormlite.dao.RawRowMapper, String...)} which returns results mapped by the caller to an Object, and
 * {@link com.j256.ormlite.dao.Dao#queryRaw(String, DataType[], String...)} which returns each results as a Object[].
 * 
 * <p>
 ...
 * 
 * <p>
 * <b>NOTE:</b> If you access the {@link #iterator()} method, you must call {@link com.j256.ormlite.dao.CloseableIterator#close()} method
...
public interface GenericRawResults<T> extends CloseableWrappedIterable<T> {
	 ...
	 * {@link com.j256.ormlite.dao.Dao#iterator()} or another iterator method was called.
	 */
