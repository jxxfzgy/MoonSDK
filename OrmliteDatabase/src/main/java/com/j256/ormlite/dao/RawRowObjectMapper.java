...
/**
 * Parameterized row mapper that takes output from the {@link com.j256.ormlite.dao.GenericRawResults} and returns a T. Is used in the
 * {@link com.j256.ormlite.dao.Dao#queryRaw(String, DataType[], com.j256.ormlite.dao.RawRowObjectMapper, String...)} method.
 * 
 * <p>
 * <b> NOTE: </b> If you need to map Strings instead then consider using the {@link com.j256.ormlite.dao.RawRowMapper} with the
 * {@link com.j256.ormlite.dao.Dao#queryRaw(String, com.j256.ormlite.dao.RawRowMapper, String...)} method which allows you to iterate over the raw results as
 * String[].
 * </p>
 * 
 * @param <T>
...
public interface RawRowObjectMapper<T> {
	 ...
	 *            {@link com.j256.ormlite.dao.Dao#queryRaw(String, DataType[], com.j256.ormlite.dao.RawRowObjectMapper, String...)}
	 * @param resultColumns
