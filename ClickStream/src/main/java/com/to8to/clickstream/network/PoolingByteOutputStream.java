 ...
 */
public class PoolingByteOutputStream extends ByteArrayOutputStream {
    /**
     ...
     */
    public PoolingByteOutputStream(BytePool pool) {
     ...
     *        minimum size.
     */
    public PoolingByteOutputStream(BytePool pool, int size) {
        mPool = pool;
